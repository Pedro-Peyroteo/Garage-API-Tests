...
public class CreateClientNegativeTest {
    ...
    @Test(description = "Create client with the birth date set to after of client date achei que ia passar ")
    ...
    @Test(description = "Create client with duplicated NIF")
    public void createClientDuplicatedNIF() throws IOException {
        ...
        Assert.assertEquals(statusCode, 409, "Código de status esperado: 409 (Conflict)");
    
    }
    @Test(description = "Create client with id")
    public void createClientWithIDTest() throws IOException {
        ...
        /* // Verificar a resposta de erro específica
    ...
    @Test(description = "Create client with Invalid postal code")
    ...
    @Test(description = "Create Client with invlaid phone number")
    public void createClientWithInvalidPhoneNumber() throws IOException {
        ...
        /* // Verificar a resposta de erro específica
        ErrorResponse expectedResponse = getPhoneNumber();
        assertErrorResponse(getErrorResponse(createResponse), expectedResponse); */
    }
