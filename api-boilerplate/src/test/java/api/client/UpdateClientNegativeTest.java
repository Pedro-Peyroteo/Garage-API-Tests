...
public class UpdateClientNegativeTest {
    ...
    @Test(description = "ID 0034 - Updade client to future date")
    public void updateClientBirthDateToFutureDateTest() throws IOException, ParseException {
        // Atualiza o cliente com novos dados
        ClientRequest updatedClientRequest = newClientRequest;
        updatedClientRequest.setBirthDate(new SimpleDateFormat("yyyy-MM-dd").format(Date.valueOf(LocalDate.now().plusDays(7))));
    ...
    public void updateClientWithInvalidPostalCode() throws IOException {
        ClientRequest updatedClientRequest = newClientRequest;
        newClientRequest.setPostalCode("376512a");
